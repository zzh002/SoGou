...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <nav class="navbar navbar-default navbar-static-top" id="n" role="navigation" >
            ...
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="/crawler/img/img1.jpg" alt="First slide">
                    </div>
                    <div class="item">
                        <img src="/crawler/img/img2.jpg" alt="Second slide">
                    </div>
                    <div class="item">
                        <img src="/crawler/img/img3.jpg" alt="Third slide">
                    </div>
                    <div class="item">
                        <img src="/crawler/img/img4.jpg" alt="Four slide">
                    </div>
                </div>
                <!-- 轮播（Carousel）导航 -->
            ...
            <ul>
                <#list lexiconDTOList as lexiconDTO>
                <li>
